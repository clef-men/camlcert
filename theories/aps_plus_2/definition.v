...
Inductive aps_plus_expr_dir ξ : data_expr → data_expr → Prop :=
  ...
  | aps_plus_expr_dir_plus_1 eₛ1 eₛ2 eₜ1 eₜ2 :
      aps_plus_expr_dir ξ eₛ1 eₜ1 →
      aps_plus_expr_aps ξ $0 eₛ2.[ren (+1)] eₜ2 →
      aps_plus_expr_dir ξ
        (eₛ1 + eₛ2)
        (let: eₜ1 in eₜ2)
  | aps_plus_expr_dir_plus_2 eₛ1 eₛ2 eₜ1 eₜ2 :
      aps_plus_expr_dir ξ eₛ2 eₜ2 →
      aps_plus_expr_aps ξ $0 eₛ1.[ren (+1)] eₜ1 →
      aps_plus_expr_dir ξ
        (eₛ1 + eₛ2)
        (let: eₜ2 in eₜ1)
...
with aps_plus_expr_aps ξ : data_expr → data_expr → data_expr → Prop :=
  ...
  | aps_plus_expr_aps_let acc eₛ1 eₛ2 eₜ1 eₜ2 :
      ...
      aps_plus_expr_aps ξ acc
        (let: eₛ1 in eₛ2)
        (let: eₜ1 in eₜ2)
  | aps_plus_expr_aps_call acc func annot eₛ func_aps eₜ eₜ' :
      ...
      aps_plus_expr_aps ξ acc
        ...
        eₜ'
  | aps_plus_expr_aps_plus_1 acc eₛ1 eₛ2 eₜ1 eₜ2 :
      aps_plus_expr_dir ξ eₛ1 eₜ1 →
      aps_plus_expr_aps ξ $0 eₛ2.[ren (+1)] eₜ2 →
      aps_plus_expr_aps ξ acc
        (eₛ1 + eₛ2)
        (let: eₜ1 + acc in eₜ2)
  | aps_plus_expr_aps_plus_2 acc eₛ1 eₛ2 eₜ1 eₜ2 :
      aps_plus_expr_dir ξ eₛ2 eₜ2 →
      aps_plus_expr_aps ξ $0 eₛ1.[ren (+1)] eₜ1 →
      aps_plus_expr_aps ξ acc
        (eₛ1 + eₛ2)
