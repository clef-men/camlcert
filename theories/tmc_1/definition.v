  ...
  with tmc_expr_dps : data_expr → data_expr → data_expr → data_expr → Prop :=
    ...
    | tmc_expr_dps_block_2 dst idx tag eₛ1 eₛ2 eₜ1 eₜ2 eₜ :
        ...
        tmc_expr_dps dst idx
          (&tag eₛ1 eₛ2)
          eₜ
    | tmc_expr_dps_block_12 dst idx tag eₛ1 eₛ2 eₜ1 eₜ2 eₜ :
        tmc_expr_dps $0 𝟙 eₛ1.[ren (+1)] eₜ1 →
        tmc_expr_dps $0 𝟚 eₛ2.[ren (+1)] eₜ2 →
        ...
        tmc_expr_dps dst idx
          (&tag eₛ1 eₛ2)
          eₜ
    | tmc_expr_dps_block_21 dst idx tag eₛ1 eₛ2 eₜ1 eₜ2 eₜ :
        tmc_expr_dps $0 𝟙 eₛ1.[ren (+1)] eₜ1 →
        tmc_expr_dps $0 𝟚 eₛ2.[ren (+1)] eₜ2 →
        eₜ = (let: &tag #() #() in dst.[ren (+1)] <-[idx.[ren (+1)]] $0 ;; eₜ2 ;; eₜ1)%data_expr →
        tmc_expr_dps dst idx
          (&tag eₛ1 eₛ2)
          eₜ.
End tmc_expr.
