...
Section sim_GS.
  ...
  Proof.
    ...
    destruct op, vₛ, vₜ; try iDestruct "Hv" as %[]; try simv_strongly_stuck;
      simv_pures;
      iApply "HΦ"; auto.
  Qed.
  ...
  Proof.
    ...
    simv_constrₜ;
      ...
      simv_constr_det as lₛ lₜ "Hl" "Hl1" "Hl2";
      iApply "HΦ"; done.
  Qed.
  ...
  Proof.
    iIntros "Hsim HΦ".
    simv_mono "Hsim". iIntros "%vₛ %vₜ #Hv".
    destruct vₛ, vₜ; try iDestruct "Hv" as %[]; try simv_strongly_stuck.
    simv_load as wₛ wₜ "Hw".
    iApply ("HΦ" with "Hw").
  Qed.

  Lemma simv_store eₛ1 eₛ2 eₜ1 eₜ2 Φ :
    SIM progₛ; eₛ1 ≳ progₜ; eₜ1 [[ X ]] [[ (≈) ]] -∗
    SIM progₛ; eₛ2 ≳ progₜ; eₜ2 [[ X ]] [[ (≈) ]] -∗
    Φ ()%V ()%V -∗
    SIM progₛ; eₛ1 <- eₛ2 ≳ progₜ; eₜ1 <- eₜ2 [[ X ]] [[ Φ ]].
