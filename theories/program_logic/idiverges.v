...
Section bi.
  ...
  Proof.
    ...
    iDestruct ("Hind" with "HI") as "(%e'' & %σ'' & %Hsteps & [HI | Hidiv])"; iClear "Hind"; last first.
  ...
  Proof.
    ...
    iDestruct ("Hind" with "HI") as "(%e' & %σ' & %Hsteps & HI)".
    auto.
  Qed.
End bi.
...
Proof.
  ...
  rewrite idiverges_fixpoint.
  intros (e' & (σ' & (Hstep%satisfiable_elim & Hisat)%satisfiable_sep)%satisfiable_exists)%satisfiable_exists.
